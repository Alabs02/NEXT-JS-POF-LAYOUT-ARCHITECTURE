      ...
      <div className="flex min-h-[calc(100vh-80px)]">
        <aside className="w-full lg:w-[80px] xl:w-[280px] shadow-md p-8 flex flex-col items-center xl:items-start gap-y-4 overflow-hidden transition-all duration-500">
          ...
          >
            ...
            <span className="hidden xl:inline-block transition-all duration-[450ms]">Home</span>
          </Link>
          <Link
            href={"/about"}
            className="active:text-blue-500 text-lg font-medium hover:text-blue-500 transition-colors duration-300 flex items-center xl:gap-x-2"
          >
            ...
            <span className="hidden xl:inline-block transition-all duration-[450ms]">About</span>
          </Link>
          <Link
            href={"/messages"}
            className="active:text-blue-500 text-lg font-medium hover:text-blue-500 transition-colors duration-300 flex items-center xl:gap-x-2"
          >
            ...
            <span className="hidden xl:inline-block transition-all duration-[450ms]">Messages</span>
          </Link>
          <Link
            href={"/notifications"}
            className="active:text-blue-500 text-lg font-medium hover:text-blue-500 transition-colors duration-300 flex items-center xl:gap-x-2"
          >
            ...
            <span className="hidden xl:inline-block transition-all duration-[450ms]">Notifications</span>
          </Link>
        </aside>

        <main className="w-[100%] lg:w-[calc(100%-80px)] xl:w-[calc(100%-280px)] col-span-10 border">{children}</main>
      </div>
    </div>
  );
};
